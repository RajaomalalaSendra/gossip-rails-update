...
100.times do |i|
	...
	User.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, description: Faker::Shakespeare.romeo_and_juliet_quote, email: Faker::Internet.email, age: 1 + rand(100), city_id: 1 +  rand(City.all.length))
